...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const maxCount = +core.getInput('filesToIgnore');
            ...
            if (((stats === null || stats === void 0 ? void 0 : stats.sloc) || 0) > maxCount) {
                core.setFailed(`The total amount of lines exceeds the maximum allowed.
        Total Amount: ${stats === null || stats === void 0 ? void 0 : stats.sloc}
        Max Count: ${maxCount}`);
            }
            core.debug(((_a = stats === null || stats === void 0 ? void 0 : stats.sloc) === null || _a === void 0 ? void 0 : _a.toString()) || '');
        }
        catch (error) {
